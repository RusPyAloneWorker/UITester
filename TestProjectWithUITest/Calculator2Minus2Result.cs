...
public class Calculator2Minus2Result: ITestScenario
{
	...
	public async Task RunAsync(IPage page)
	{
		...
		await CalculatorPage.OperationSelector.SelectOptionAsync(CalculatorPage.Operators.Minus);
	...
	public string ScenarioName { get; } = "Calculate 2 minus 2";
}